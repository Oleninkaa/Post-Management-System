...
/*
cm = new SqlCommand("UPDATE tbReciept SET name=@name, total = @total", cn);
cm.Parameters.AddWithValue("@name", dgvCustomer.Rows[e.RowIndex].Cells[1].Value.ToString());
cm.Parameters.AddWithValue("@total", 5);
